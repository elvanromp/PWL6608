...
<body>
	...
	?>
	<div class="utama">
		<h2 class="my-3 text-center">Tambah Data Mata Kuliahh</h2>
				...
				<div class="row">
					<div class="form-group mb-3 col">
						...
						<div style="display: flex;">
							...
							<input class="form-control" type="text" name="idmatkul" id="idmatkul" required style="width: 100%" maxlength="5">
						</div>
					</div>
				</div>
				<div class="row">
