		...
		<div class="col-sm-9">
          ...
          <div class="form-group col-3">
            ...
            <select class="form-select px-2 w-100" name="ruang" style="height: 40px; width: 50%;border :1px solid #ced4da;border-radius: 0.25rem;" required>
                                ...
                                <option value="H.3.4" <?= $row['ruang'] == "H.3.4"? ' selected="selected"' : ''; ?>>H.3.4</option>
                                <option value="H.3.5" <?= $row['ruang'] == "H.3.5"? ' selected="selected"' : ''; ?>>H.3.5</option>
                                <option value="H.3.6" <?= $row['ruang'] == "H.3.6"? ' selected="selected"' : ''; ?>>H.3.6</option>
                                <option value="H.3.7" <?= $row['ruang'] == "H.3.7"? ' selected="selected"' : ''; ?>>H.3.7</option>
                                <option value="H.3.8" <?= $row['ruang'] == "H.3.8"? ' selected="selected"' : ''; ?>>H.3.8</option>
                                <option value="H.3.9" <?= $row['ruang'] == "H.3.9"? ' selected="selected"' : ''; ?>>H.3.9</option>
                                <option value="H.3.10" <?= $row['ruang'] == "H.3.10"? ' selected="selected"' : ''; ?>>H.3.10</option>
                                ...
                                <option value="H.4.4" <?= $row['ruang'] == "H.4.4"? ' selected="selected"' : ''; ?>>H.4.4</option>
                                <option value="H.4.5" <?= $row['ruang'] == "H.4.5"? ' selected="selected"' : ''; ?>>H.4.5</option>
                                <option value="H.4.6" <?= $row['ruang'] == "H.4.6"? ' selected="selected"' : ''; ?>>H.4.6</option>
                                <option value="H.4.7" <?= $row['ruang'] == "H.4.7"? ' selected="selected"' : ''; ?>>H.4.7</option>
                                <option value="H.4.8" <?= $row['ruang'] == "H.4.8"? ' selected="selected"' : ''; ?>>H.4.8</option>
                                ...
                                <option value="H.5.4" <?= $row['ruang'] == "H.5.4"? ' selected="selected"' : ''; ?>>H.5.4</option>
                                <option value="H.5.5" <?= $row['ruang'] == "H.5.5"? ' selected="selected"' : ''; ?>>H.5.5</option>
                                <option value="H.5.6" <?= $row['ruang'] == "H.5.6"? ' selected="selected"' : ''; ?>>H.5.6</option>
                                <option value="H.5.7" <?= $row['ruang'] == "H.5.7"? ' selected="selected"' : ''; ?>>H.5.7</option>
                                ...
                                <option value="H.7.4" <?= $row['ruang'] == "H.7.4"? ' selected="selected"' : ''; ?>>H.7.4</option>
                            </select>
					</div>
        </div>
